...
const englishTranslations: Record<string, string> = {
  ...
  "Tofu asado, mix de portobellos, remolacha, pepino, pipas de calabaza, cebolla encurtida, arroz blanco, kale, sésamo y vinagreta de soja jengibre.": "Roasted tofu, mixed portobello mushrooms, beetroot, cucumber, pumpkin seeds, pickled onion, white rice, kale, sesame and soy-ginger vinaigrette.",
  "Pollo a la naranja, noodles de calabacín, zanahoria, col lombarda, pepino, arroz blanco, cebolla crusty, cilantro, almendras y vinagreta de anacardos.": "Orange chicken, courgette noodles, carrot, red cabbage, cucumber, white rice, crispy onion, coriander, almonds and cashew vinaigrette.",
...
const saladBowls: MenuGroup = {
  ...
  items: [
    ...
    },
    {
      ...
      price: "14,90 €",
      description:
        "Tofu asado, mix de portobellos, remolacha, pepino, pipas de calabaza, cebolla encurtida, arroz blanco, kale, sésamo y vinagreta de soja jengibre.",
    },
    {
      name: "Crusty",
      price: "13,90 €",
      description:
        "Pollo a la naranja, noodles de calabacín, zanahoria, col lombarda, pepino, arroz blanco, cebolla crusty, cilantro, almendras y vinagreta de anacardos.",
    },
  ],
};
...
const coffee: MenuGroup = {
  title: "Bebidas",
  items: [
    { name: "Café solo · Espresso", price: "2,10 €" },
    { name: "Cortado", price: "2,10 €" },
    { name: "Americano", price: "2,40 €" },
    { name: "Café con leche", price: "2,80 €" },
    { name: "Café con leche XL", price: "3,40 €" },
    { name: "Café con leche sin lactosa, soja o avena", price: "3,00 €" },
    { name: "Café con leche sin lactosa, soja o avena XL", price: "3,40 €" },
    { name: "Cappuccino", price: "3,10 €" },
    { name: "Frappé", price: "4,10 €", description: "Con leche, hielo y sirope." },
    { name: "Carajillo", price: "4,80 €" },
    { name: "Colacao", price: "3,40 €" },
    { name: "Té e infusiones", price: "3,00 €" },
    { name: "Matcha Latte Caliente", price: "4,00 €" },
    { name: "Matcha Latte Frío", price: "4,10 €" },
    { name: "Ube Latte Caliente", price: "4,00 €", description: "Hierbas filipinas con notas a vainilla y frutos secos. Cero cafeína." },
    { name: "Ube Latte Frío", price: "4,10 €", description: "Hierbas filipinas con notas a vainilla y frutos secos. Cero cafeína." },
  ],
};
